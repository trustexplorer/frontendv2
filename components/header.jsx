...
import { Menu, X, ChevronDown, Shield, Search, LogOut, LayoutDashboard } from "lucide-react";
...
export function Header() {
  ...
  const isLoggedIn = token || (typeof window !== "undefined" && localStorage.getItem("token"));
